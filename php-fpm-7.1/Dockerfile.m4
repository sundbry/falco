...
RUN add-apt-repository ppa:ondrej/php && \
  apt-get -y -q update && \
  apt-get -q -y install php7.1 php7.1-dev php7.1-fpm php7.1-gd php7.1-pgsql php7.1-mysql php7.1-mcrypt php7.1-xmlrpc php7.1-curl php7.1-mbstring php7.1-xml php7.1-intl php7.1-zip
